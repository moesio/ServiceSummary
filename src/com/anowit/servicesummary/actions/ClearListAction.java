...
public class ClearListAction extends ActionMenu {
	...
	public void runAction() {
		...
		itemRemovalDialog.setButton(AlertDialog.BUTTON_POSITIVE, context.getResources().getString(android.R.string.yes), listener);
		itemRemovalDialog.setButton(AlertDialog.BUTTON_NEGATIVE, context.getResources().getString(android.R.string.no), listener);
